defmodule GameniteWeb.Components.DrawingCanvas do
  ...
  def render(assigns) do
    ~F"""
    <div phx-hook="UpdateCanvas" x-data="drawingCanvas()">
      {#if @drawing_user_id == @user_id}
      <div @mouseup="mouseUp()" @mousedown="mouseDown($event)" @mousemove="draw($event);">
      ...
      <div class="flex space-x-4 md:space-x-8 justify-center items-center pt-4">
        ...
        <div class="flex space-x-1">
          <button :class="drawingType == 'pen' ? 'bg-blurple' : 'bg-white'" class="h-16 w-16 border-0 shadow-md" @click="draw($event); drawingType = 'pen';">
