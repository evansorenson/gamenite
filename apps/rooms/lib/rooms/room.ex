defmodule Rooms.Room do
  ...
  alias Rooms.{Message, Roommate}

  @roommate_colors Application.get_env(:rooms, :roommate_colors)
  ...
  defstruct slug: nil,
            ...
            previous_roommates: %{},
            messages: [],
            available_colors: @roommate_colors,
            game_title: nil,
  ...
  defp do_join(
         %{id: id} = roommate,
         %{roommates: roommates, available_colors: available_colors} = room
       ) do
    %{
      room
      | available_colors: List.delete(available_colors, roommate.color),
        roommates: Map.put(roommates, id, %{roommate | connected?: true})
    }
  end
